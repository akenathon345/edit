...
4. SÉLECTIVITÉ : garde UNIQUEMENT les directives à fort impact. Le monteur ne veut pas 15 retours dont 10 mineurs — il veut les 5-8 corrections qui changent vraiment la vidéo. En cas de doute, SUPPRIMER la directive.

5. ORDRE CHRONOLOGIQUE : trier toutes les directives par timecode croissant

6. TOLÉRANCE MARQUE : la transcription audio peut mal orthographier la marque du client (ex : "EZAK" → "HEYZACK"). Si une directive demande de virer/flouter ce qui est en fait la marque du client, SUPPRIMER cette directive.

7. SCORE /10 : évaluer la qualité du montage original
